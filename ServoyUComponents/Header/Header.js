angular.module('servoyucomponentsHeader', ['servoy']).directive('servoyucomponentsHeader', ["formatFilterFilter", "$http", function(formatFilter, $http) {
    return {
        restrict: 'E',
        scope: {
            model: '=svyModel',
        ...
        templateUrl: 'servoyucomponents/Header/Header.html'
    };
}])
