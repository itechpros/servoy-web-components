            ...
            return {
                ...
                link: function($scope, $element, $attrs) {
                    return $scope.$on('advanced-searchbox:setFocusOn', function(e, id) {
						if (id && id.target && id.target.children && id.target.children.namedItem('searchbox')) id.target.children.namedItem('searchbox').focus()
                ...
                link: function($scope, $element, $attrs) {
                    ...
                    function resize() {
                        $timeout(function() {
                            ...
                            if (shadow.outerWidth()) $element.css('width', shadow.outerWidth() + 10);
                        });
                    }
