angular.module('itechCalendarPro', [ 'servoy' ]).directive('itechCalendarPro', function($log, $apifunctions, $svyProperties, $sabloConstants,$sabloApplication,$applicationService,$animate) {
	return {
		restrict : 'E',
		scope : {
			model : "=svyModel",
